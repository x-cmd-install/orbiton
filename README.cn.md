...
![orbiton](https://repo.x-cmd.io/orbiton.svg?lang=zh)
...
合计: **45,026** 行代码（覆盖前 5 种语言、共 **190** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Go | 43,367 | 5,908 | 4,808 | 176 |
| Cpp | 606 | 133 | 81 | 2 |
| Python | 322 | 36 | 81 | 1 |
| Sh | 205 | 40 | 40 | 10 |
| Makefile | 116 | 6 | 28 | 1 |
...
- **上游仓库**: <https://github.com/xyproto/orbiton>
- **官网**: <https://roboticoverlords.org/orbiton>
- **许可证**: BSD-3-Clause
...
- **Star**: 700 · **Fork**: 18 · **开放 issue**: 16 · **贡献者**: 5

## 累计统计

- **发布数**: 140 · **已合并 PR**: 9 · **开放 PR**: 0 · **已关闭 issue**: 16 · **开放 issue**: 0 · **提交数**: 6419

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-13 | 0 | 1 | 0 | 0 | 0 | 26 |
| last60d | 2026-07-14 | 0 | 1 | 0 | 0 | 0 | 99 |
| 90d | 2026-06-14 | 1 | 1 | 0 | 1 | 0 | 145 |
| last180d | 2026-03-16 | 6 | 1 | 0 | 2 | 0 | 624 |
| 360d | 2025-09-17 | 12 | 1 | 0 | 3 | 0 | 1124 |
| last720d | 2024-09-22 | 24 | 2 | 0 | 4 | 0 | 1831 |
...
在 [repology.org](https://repology.org/project/orbiton) 上共有 **26** 个发行版报告此项目。**20** 个 ✅ 已是最新上游版本，**5** 个 ⚠️ 使用旧版本。
...
orbiton 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `orbiton` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/orbiton.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260912.yml` · 2026-09-12T05:49:22Z._
